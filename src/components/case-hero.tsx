  ...
  return (
    <section className="border-b border-rule">
      <Wrap className="py-16 md:py-24">
        ...
        <h1 className="display mt-7 max-w-5xl text-[2rem] sm:text-5xl md:text-[4rem]">
          {title}
        </h1>
  ...
  return (
    <Wrap className="mt-24">
      ...
      >
        ...
        <p className="display mt-3 max-w-3xl text-2xl transition-colors group-hover:bg-mark md:text-[2.75rem]">
          {next.title}
        </p>
      </Link>
    </Wrap>
